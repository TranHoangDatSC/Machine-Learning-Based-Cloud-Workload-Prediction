"""Sinh bản Word của bản thảo từ Markdown, dùng CHÍNH template HJS của tạp chí.
    ...
    python scripts/tao_docx.py --vao paper/ban-thao-v1.md --ra paper/ban-thao-v1.docx
...
def main() -> int:
    ...
    ap.add_argument("--vao", default="paper/ban-thao-v1.md")
    ap.add_argument("--ra", default="paper/ban-thao-v1.docx")
    a = ap.parse_args()
